...
#define MEMORY_DELAY_TO_FIRST_BYTE 16
#define MEMORY_DELAY_TO_LAST_BYTE_OF_WORD 19
...
//structs
///struct the helps for bus address managment
typedef struct{
	uint32_t address;
	uint16_t offset;
	uint16_t block;
...
/// <summary>
/// struct for combining the needed pipeline data
/// </summary>
typedef struct{
...
/// <summary>
/// struct for combining the data from bus
/// </summary>
typedef struct{
...
/// <summary>
/// struct for communicating with functions between bus and cache
/// </summary>
typedef struct{
	int core_number;
...
/// <summary>
/// struct for combining the necessary cache data
/// </summary>
typedef struct {
	core_identifier id;
	bool memory_stall;
...
/// <summary>
/// global variable for the files - we are writing into the files along all the program execution
/// </summary>
extern current_core_data_files files_of_cores[CORES_NUMBER];
FILE* memory_input_file;
FILE* memory_output_file;
FILE* bus_trace_file;
//declaring the pointers into cache-bus communication
